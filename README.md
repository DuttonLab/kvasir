...
Kvasir uses a [MongoDB](https://www.mongodb.com/) database to store genome and
HGT information, so you'll need to install
[mongodb](https://www.mongodb.com/download-center?jmp=nav#community) and
[PyMongo](https://api.mongodb.com/python/current/installation.html) before doing
anything.
...
[Genbank](https://www.ncbi.nlm.nih.gov/Sitemap/samplerecord.html) format. You
...
[BLAST+](https://www.ncbi.nlm.nih.gov/books/NBK279671/) command line tools. This
...
idea of "species distance" and there are some useful
functions`bin/kv_distance.py`.
...
This is calculated using a ruby script from [enveomics](https://github.com/lmrodriguezr/enveomics/blob/master/Scripts/ani.rb).
